...
THEANO_FLAGS=allow_gc=False,exception_verbosity=high,cuda.root=/usr/bin/cuda,warn_float64=warn,device=$DEVICE,floatX=float32 python run.py $LSTM_NLI_FLAGS
